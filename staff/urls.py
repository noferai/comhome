...
urlpatterns = [
	...
	path('create/', CreateStaffView.as_view(), name='new_staff'),
	path('<int:pk>/view/', StaffDetailView.as_view(), name="view_staff"),
	path('<int:pk>/edit/', StaffUpdateView.as_view(), name="edit_staff"),
	path('<int:pk>/delete/', StaffDeleteView.as_view(), name="remove_staff"),
